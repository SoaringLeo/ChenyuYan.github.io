...
This model considers the charge injection, migration, trapping/detrapping and recombination  as a dynamic process and depicts the continuous motion process of charges in the bulk of dielectrics.
...
Charges are continuously injected from electrodes to the bulk of samples, and they may be captured by traps (both shallow traps and deep ones). When captured by deep traps, charges need to obtain higher energy to detrap and retain a more extended period. Also, during the migration from one electrode to another, a combination may occur when a positive charge encounters a negative one. Such a dynamic process includes the entire charge motion process. By setting boundaries of the model and solving Poisson's equation, this model can be used for calculating the charge transport property in the bulk of insulating material, including numerical calculation of space charge and electric field distribution, energy gained by electrons as well, as electrical strength. This model was once used for explaining the electrical breakdown behavior of polypropylene (PP, used for the film of power capacitor) nanocomposite. By combining the experimental results and calculation of the model, the hidden electrical breakdown mechanism of PP nanocomposite was revealed. Details regarding the model can be found in [Carrier Transport and Molecular Displacement Modulated dc Electrical Breakdown of Polypropylene Nanocomposites](https://www.mdpi.com/2073-4360/10/11/1207/pdf).

Based on this model, we investigate the electrical breakdown property of PI samples with various thicknesses. It is found that a similar mechanism modulates the breakdown behavior of PI and simulation better fits than the space charge electrical breakdown (SCEB) model. We also find similarities and differences in the breakdown mechanism of various dielectric materials. Relating results and comparison can be found in [Thickness-Dependent DC Electrical Breakdown of Polyimide Modulated by Charge Transport and Molecular Displacement.](https://www.mdpi.com/2073-4360/10/9/1012/pdf)

This model can further be applied to the charge transport in other systems, not limiting to insulation material system since regularity of charge behavior exists in any system with the external electric field applied. Currently, in our research group, this model is also modified and utilized in the area of ultra-high thermal conductivity and carrier migration in the reliable battery. In the future, it is promising to combine this model of machine learning to determine a more accurate probability of charge behavior so that it can more closely reveal the charge migration property in the system. Also, the dimension of charge transport can be extended to 3D to show a tridimensional picture of its motion property.

**Dielectric property simulation of insulating dielectrics**

Method of modeling on dielectric property of aging Silicone Rubber is proposed. Specifically, by fitting the spectra to theoretical equations, we separated different polarization processes at various frequencies and calculated the values of corresponding parameters like thermal expansion coefficient, swelling ratio, etc. By utilizing the correlations among multiple parameters, polarization property, and specific process of SiR was delineated. Additionally, the paper investigated the influence of degradation on the dielectric constant at high frequencies, ion concentration, conductivity, and trap distribution, illustrating the charge transport property in the bulk of SiR and revealed the hidden cause for polarization. More information can be seen in [Dielectric and Carrier Transport Properties of Silicone Rubber Degraded by Gamma Irradiation](https://www.mdpi.com/2073-4360/9/10/533/pdf)
...
This project originated from the need for power equipment like cable and bush to deteriorate under the high-order harmonics, which hence declined the performance of the power system. The study, taking the silicon rubber from the outer coat of cable terminals and the insulating oil paper in the bush as the research objects, quantificationally manifested the aging status and summarized the insulating material deterioration regularity. Besides, the aging model was proposed to predict the lifespans of cable and bush. At the same time, the electrical breakdown process can be well uncovered and lucidly demonstrated. I was responsible for experiment design, experiment accomplishment, modeling calculation, and paper writing.

## Work Experience and Internship ## 

**State Grid Corporation of China   Department of Information and Internet	2019.08 - 2020.09** 
...
I was an internship in the technology department in ABB for four months. During this period, I understood the industrialization of the power system, especially the power capacitor. With an increase in familiarity with equipment, I have a more lucid concept of the power system structure and commercial market in this field. Plus, with the support of investigation in the equipment workshop, I learned the capacitor's processing flow, starting from the polypropylene film fabrication to the component assembly. Additionally, I also got an opportunity to be engaged in the technical discussion with foreign experts, which primarily inspires my further exploration of the research. Through the intensive seminar, I found that increasing demand for high voltage transmission had been an urgent need for grids in China. However, the property of electric breakdown was a critical factor that determined the performance of power capacity. Therefore, when choosing the research field in my master phase, I approached my professor and expressed my plan for the research of the breakdown property of polypropylene. One more thing, it is worth mentioning that I developed a program based on C++ during my internship to help collect documents to meet the needs of engineers, which has been integrated into the system of ABB and used until now.

## Skill Highlight

1. **Good modeling and calculation ability**

   Not only in charge transport modeling and material modeling, but I can also fluently use MATLAB, SPSS, Python, and TensorFlow to subordinate academic work.

2. **Proficient in electronics and material science**

   Familiar with the electronic device and material fabrication, characterization, and testing methods, also capable of offering theoretical analysis due to a relatively solid foundation of physics and chemistry.

3. **Excellent ability of data processing**

   A study of experimental results and data processing can be well conducted due to a combination of experiment analysis (relying on a clear understanding of experimental principle and mechanism). This ability also guarantees quick adaptability and improves research efficiency when facing new practical projects. 
...
Finally, I am a good learner for new challenges, and I like to combine theoretical analysis with practical application. Numerous unexpected problems can inevitably arise during the study and academic research. I enjoy solving problems and obtain new skills. For instance, when I started to participate in MCM, I became familiar with new models whenever I faced further questions. Also, it is my initial experience for numerical calculation, like the Genetic Algorithm, greedy algorithm, Dynamic Programming, etc., and formal paper writing, like structure, format, details, and demonstration skills, which paves the way for my following research. I firmly believe that I can do more and better once I decide to make it.
